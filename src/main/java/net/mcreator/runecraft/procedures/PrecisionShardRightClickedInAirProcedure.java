...
public class PrecisionShardRightClickedInAirProcedure extends RunecraftModElements.ModElement {
	public PrecisionShardRightClickedInAirProcedure(RunecraftModElements instance) {
		super(instance, 75);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure PrecisionShardRightClickedInAir!");
			return;
		}
