...
public class NoxusBiome extends RunecraftModElements.ModElement {
	@ObjectHolder("runecraft:noxus")
	public static final CustomBiome biome = null;
	public NoxusBiome(RunecraftModElements instance) {
		super(instance, 19);
	}
